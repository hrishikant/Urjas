...
struct MarkMomentIntent: AppIntent {
    ...
    static var description = IntentDescription("Record a timestamped moment in Ūrjas.")
...
/// Surfaces Ūrjas's intents to Siri, Spotlight, and the Shortcuts gallery without any user setup.
