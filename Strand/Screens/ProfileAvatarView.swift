...
//
// LOCAL-ONLY: the photo lives in UserDefaults on this device and is never uploaded (Ūrjas is
...
struct ProfileAvatarView: View {
    ...
    var body: some View {
        if let image = decodedImage {
            ...
            // Fallback: the Ūrjas loop BrandMark (the green ring + white core) instead of a generic
