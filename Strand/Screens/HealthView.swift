...
/// captioned with its in-range state. Re-skinned to the locked Ūrjas component
        ...
        VStack(alignment: .leading, spacing: NoopMetrics.gap) {
            ...
            NoopCard(tint: StrandPalette.chargeColor) {
                VStack(alignment: .leading, spacing: NoopMetrics.cardInnerSpacing) {
                    ...
                    // Route the manual offload kick through the unified Ūrjas button system so the
        ...
        NoopCard(tint: StrandPalette.chargeColor) {
            VStack(alignment: .leading, spacing: NoopMetrics.space4) {
                HStack(spacing: NoopMetrics.rowSpacing) {
                    confidencePill
                    Spacer(minLength: 0)
                    // Force-recompute affordance: Ūrjas scores Fitness Age weekly, so this applies it NOW
