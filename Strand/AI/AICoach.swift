...
//
// Ūrjas is offline by design. This file is the single exception: when the user pastes their OWN
// API key for a provider they choose, Ūrjas can send a compact text summary of their metrics plus
