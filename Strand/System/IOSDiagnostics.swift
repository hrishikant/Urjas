...
struct IOSDiagnostics {
    ...
    /// macOS: best-effort "is this a signed plus notarized build". Ūrjas's macOS build is intentionally
    ...
    /// Honest signing/notarization probe. Ūrjas's macOS build ships unsigned for anonymity, so this is
