...
/// `weak` shared accessor lets an intent fired while Ūrjas is closed fail with a clear "open Ūrjas"
...
enum NOOPIntentError: Error, CustomLocalizedStringResourceConvertible {
    ...
    var localizedStringResource: LocalizedStringResource {
        switch self {
        case .notRunning:   return "Open Ūrjas first so it can reach your strap."
        case .notConnected: return "Connect your WHOOP strap in Ūrjas, then try again."
        }
    }
}
