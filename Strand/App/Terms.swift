...
/// full text lives in `TERMS.md`, shipped with Ūrjas.
enum Terms {
    ...
    static let points: [(String, String)] = [
        (String(localized: "Independent: not affiliated with WHOOP"),
         String(localized: "Ūrjas is an unofficial project: not affiliated with, endorsed by, or sponsored by WHOOP, Inc. \"WHOOP\" is their trademark, used only to name the hardware Ūrjas works with.")),
        (String(localized: "Using Ūrjas may breach WHOOP's Terms of Service"),
        ...
        (String(localized: "Experimental: at your own risk"),
         String(localized: "Ūrjas talks to your strap's firmware over an unofficial, independently-mapped protocol. There is a residual risk to the device, its data, and its connection to official services. You assume that risk.")),
        (String(localized: "Not a medical device, not medical advice"),
         String(localized: "Every metric is an unvalidated approximation. Don't use Ūrjas to diagnose, treat, or make any health decision. Always consult a qualified professional.")),
        (String(localized: "No warranty; liability limited"),
         String(localized: "Ūrjas is free and provided \"as is\", with no warranty. Liability is limited to the maximum extent the law that applies to you allows, and nothing here removes protections your local law won't let us remove.")),
    ]
    ...
    static let attestations: [String] = [
        String(localized: "I am not a WHOOP employee, contractor, or affiliate, and I am not using Ūrjas on WHOOP's behalf."),
        String(localized: "I own the WHOOP device I will use with Ūrjas and will only use it to access my own data. Doing so is my decision and my risk, including any effect on my WHOOP account, subscription, device, or warranty, and it may breach WHOOP's Terms of Service."),
        String(localized: "I understand Ūrjas is unofficial and experimental, is provided free and \"as is\" with no warranty, and is not a medical device or medical advice."),
        String(localized: "To the fullest extent the law allows, I will not hold the Ūrjas project or its contributors liable for any loss or damage arising from my use of it."),
    ]
}
