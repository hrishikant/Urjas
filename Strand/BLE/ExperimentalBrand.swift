...
public enum ExperimentalBrand: String, CaseIterable, Sendable, Equatable {
    ...
    /// "Broadcast Heart Rate" on the watch — there is no Ūrjas-proprietary Garmin protocol.
    case garmin
    ...
    /// Whether this brand can stream LIVE heart rate at all in Ūrjas's experimental tier. Derived from the
