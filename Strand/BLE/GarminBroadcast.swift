...
///
/// HONEST, NON-PROPRIETARY BY DESIGN. Garmin watches do NOT expose a Ūrjas-readable proprietary live
...
public enum GarminBroadcast {
    ...
    /// Step-by-step guidance to put a Garmin watch into Broadcast Heart Rate mode so Ūrjas (and any other
