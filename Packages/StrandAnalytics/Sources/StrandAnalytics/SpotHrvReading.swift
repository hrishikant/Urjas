...
///
/// Swift parity twin of `android/.../analytics/SpotHrvReading.kt`. This wraps Ūrjas's canonical
...
///  - Ūrjas's nightly HRV (`avgHrv`, fed into Vitality / Fitness Age) uses `HRVAnalyzer.rmssdRaw`, which
...
public enum SpotHrvReading {
    ...
    /// capture window. Runs Ūrjas's canonical cleaning + RMSSD (range filter -> Malik ectopic rejection
