...
//
// Spec-deterministic field parsing for the four FTMS machine-data characteristics Ūrjas reads live:
...
// Supplement" characteristic field tables. Ūrjas's own clean re-implementation of the public spec.
